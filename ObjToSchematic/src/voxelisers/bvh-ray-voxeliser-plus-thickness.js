 ...
 */
var BVHRayVoxeliserPlusThickness = /** @class */ (function (_super) {
    __extends(BVHRayVoxeliserPlusThickness, _super);
    function BVHRayVoxeliserPlusThickness() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BVHRayVoxeliserPlusThickness.prototype._voxelise = function (mesh, voxeliseParams) {
        ...
        for (rayIndex = 0; rayIndex < rays.length; ++rayIndex) {
            ...
            for (var _i = 0, intersections_1 = intersections; _i < intersections_1.length; _i++) {
                ...
                var triangle = mesh.getUVTriangle(intersection.triangleIndex);
                var v0 = vector_1.Vector3.sub(triangle.v1, triangle.v0);
                var v1 = vector_1.Vector3.sub(triangle.v2, triangle.v0);
                var crossVec = vector_1.Vector3.cross(v1, v0);
                var depthPosition = position.copy().add(crossVec.normalise().mulScalar(0.5)).round();
